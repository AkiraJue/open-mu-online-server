...
public:
	...
	//----------------------------------------------------------------
	void	SendTextMsg(int Type,char * Text, ...);
	//----------------------------------------------------------------
	void	SendAllTextMsg(int Type,char * Text, ...);
	//----------------------------------------------------------------
	void	Disconnect();
	//----------------------------------------------------------------
	...
	//----------------------------------------------------------------
	int		RemoveMoney(int Count);
	//----------------------------------------------------------------
	bool	CanUseCommand(char* CommandID);
private:
	DWORD  aIndex;
	//----------------------------------------------------------------
	char   query[100];
...
enum USER_BUFFS
{
	...
	GREATER_DEFENCE					= 27,
	GREATER_DAMAGE					= 28,
	INCREASE_ATTACK_SUCESS_RATE		= 304,
	INCREASE_ATTACK_RATE			= 309,
	INCREASE_DEFENCE				= 314
};extern USER_BUFFS PlayerBuffList;
