...
void Logger::Init()
{
	...
	this->Write("//////////////////////////////////////////////////////////////////////////////"							);
	this->Write("// Open Mu Online Server (OMOS)"																			);
	this->Write("//////////////////////////////////////////////////////////////////////////////"							);
	...
	this->Write("//////////////////////////////////////////////////////////////////////////////"							);
	this->Write("// Last Edit Date		: 26 / 12 / 2010 "																		);
	this->Write("//////////////////////////////////////////////////////////////////////////////"							);
}
void Logger::Write(const char* Format, ...)
{
	...
	char FileName[255];
	sprintf(FileName,".\\CONSOLE_LOG\\OMOS_Console(%02d.%02d.%02d).log", t.wDay, t.wMonth, t.wYear);
